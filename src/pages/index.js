  ...
  <Layout>
    ...
    <section>
      ...
      <p>
        ...
        is <u>underlined</u> and this is code: . Finally,{" "}
      ...
      <div class="row">
        ...
        <div class="3u$ 6u$(small) 12u$(xsmall)">
          <ul class="actions vertical small">
            ...
            <li>
              <a href="#" class="button alt small fit">
                Small
              </a>
            </li>
          </ul>
    ...
    <section>
      ...
      <div class="row">
        ...
        <div class="6u$ 12u$(xsmall)">
          <ul class="actions fit small">
            ...
            <li>
              <a href="#" class="button alt fit small">
                Fit + Small
              </a>
            </li>
          </ul>
      ...
      <ul class="actions">
        <li>
          <a href="#" class="button special icon fa-download">
            Icon
          </a>
        </li>
        <li>
        ...
        <li>
          <a href="#" class="button alt icon fa-download">
            Icon
          </a>
        </li>
      </ul>
      <ul class="actions">
        ...
        <li>
          <span class="button alt disabled">Alternate</span>
        </li>
      </ul>
    </section>
    <div style={{ maxWidth: `300px`, marginBottom: `1.45rem` }}></div>
